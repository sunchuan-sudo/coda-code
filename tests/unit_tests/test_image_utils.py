...
from coda_cli.image_utils import (
    ImageData,
...
class TestGetClipboardImage:
    ...
    @patch("coda_cli.image_utils.sys.platform", "linux")
    ...
    @patch("coda_cli.image_utils.sys.platform", "darwin")
    @patch("coda_cli.image_utils._get_macos_clipboard_image")
    ...
    @patch("coda_cli.image_utils.sys.platform", "darwin")
    @patch("coda_cli.image_utils.subprocess.run")
    ...
    @patch("coda_cli.image_utils.sys.platform", "darwin")
    @patch("coda_cli.image_utils._get_clipboard_via_osascript")
    @patch("coda_cli.image_utils.subprocess.run")
