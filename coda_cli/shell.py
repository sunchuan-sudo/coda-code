"""Simplified middleware that exposes a basic shell tool to CoDA Code."""
...
class ShellMiddleware(AgentMiddleware[AgentState, Any]):
    """Give basic shell access to CoDA Code via the shell.

    This shell will execute on the local machine and has NO safeguards except
    for the human in the loop safeguard provided by CoDA Code itself.
    """
