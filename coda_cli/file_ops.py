"""Helpers for tracking file operations and computing diffs for CoDA Code display."""
...
from coda_cli.config import settings
...
class FileOpTracker:
    """Collect file operation metrics during CoDA Code interaction."""
