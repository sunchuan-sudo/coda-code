...
- coda skills list --agent <agent> [--project]
- coda skills create <name>
- coda skills info <name>
"""
...
from coda_cli.config import COLORS, Settings, console
from coda_cli.skills.load import list_skills
...
def _list(agent: str, *, project: bool = False) -> None:
    ...
    if project:
        ...
        if not project_skills_dir.exists() or not any(project_skills_dir.iterdir()):
            ...
            console.print(
                "\n[dim]Create a project skill:\n  coda skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
        ...
        if not skills:
            ...
            console.print(
                "[dim]Skills will be created in ~/.coda/agent/skills/ when you add them.[/dim]",
                style=COLORS["dim"],
            )
            console.print(
                "\n[dim]Create your first skill:\n  coda skills create my-skill[/dim]",
                style=COLORS["dim"],
            )
            return
...
# license: Apache-2.0
# compatibility: Designed for CoDA Code
# metadata:
#   author: your-org
#   version: "0.1"
...
def execute_skills_command(args: argparse.Namespace) -> None:
    ...
    if args.skills_command == "list":
        ...
        console.print("  coda skills <command> [options]\n")
        ...
        console.print("  coda skills list")
        console.print("  coda skills create web-research")
        console.print("  coda skills info web-research")
        console.print("\n[dim]For more help on a specific command:[/dim]", style=COLORS["dim"])
        console.print("  coda skills <command> --help", style=COLORS["dim"])
